...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 class="text-3xl font-bold mb-8">Portfolio</h1><p class="text-gray-600 dark:text-gray-300">Collections coming soon...</p></div>`);
}
...
//# sourceMappingURL=index-CIr50loN.mjs.map
