...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 class="text-4xl font-bold text-center py-16">Welcome</h1><p class="text-center text-gray-600 dark:text-gray-300"> Philosopher, Developer, Photographer </p></div>`);
}
...
//# sourceMappingURL=index-CJmfqN5N.mjs.map
