import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineAsyncComponent, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, watch, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'file:///Users/sumitkumarpandit/codebase/misc/SumitKPandit.github.io/node_modules/.pnpm/vue@3.5.21_typescript@5.9.2/node_modules/vue/index.mjs';
...
import { hasProtocol, isScriptProtocol, joinURL, withQuery, withBase } from 'file:///Users/sumitkumarpandit/codebase/misc/SumitKPandit.github.io/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs';
...
import { getContext, executeAsync } from 'file:///Users/sumitkumarpandit/codebase/misc/SumitKPandit.github.io/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///Users/sumitkumarpandit/codebase/misc/SumitKPandit.github.io/node_modules/.pnpm/h3@1.15.4/node_modules/h3/dist/index.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/sumitkumarpandit/codebase/misc/SumitKPandit.github.io/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/sumitkumarpandit/codebase/misc/SumitKPandit.github.io/node_modules/.pnpm/vue@3.5.21_typescript@5.9.2/node_modules/vue/server-renderer/index.mjs';
...
const mr = Symbol.toStringTag, wi = n$1((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n$1((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Ks = n$1((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Js = n$1((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import('./multipart-parser-D2-Q3q_N.mjs');
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CJmfqN5N.mjs')
  },
  {
    name: "resume",
    path: "/resume",
    component: () => import('./resume-Co5C8UE1.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-dqgj17MJ.mjs')
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-H81nxadg.mjs')
  },
  {
    name: "portfolio",
    path: "/portfolio",
    component: () => import('./index-CIr50loN.mjs')
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-DUJGk_8Q.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-CAB0TJEq.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-5Uhl-WxX.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-DGH7khSX.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-RHpM8rVt.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-CTBSs1sJ.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyContentSlot = defineAsyncComponent(() => import('./ContentSlot-B9iVwbhB.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyDocumentDrivenEmpty = defineAsyncComponent(() => import('./DocumentDrivenEmpty-CR-cA0Tu.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import('./DocumentDrivenNotFound-BdeoTkgb.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyMarkdown = defineAsyncComponent(() => import('./Markdown-CLm1u-Y6.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-BZv1mp2R.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-7pEC69mj.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-CxriO2CP.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-C5MvwxPX.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-Breja3z2.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-CvinB5fr.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-qK6VaFo_.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-CCEUgBiU.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-DnlNSqS4.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-DM9vwsFu.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-xk7B_4sG.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-C_qZSXL3.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bwi9GAnO.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-CW2iBlCT.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-2Md9Agfk.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-BE0Koydj.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-DudwQY1O.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-BsNgA1e2.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-Cmac2cIL.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-BqWRFT5A.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-1tuX6ip2.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-BSOTGT2Z.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-bde-5ssO.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-B9pHK__3.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-BIgco3PR.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-CVqlX2Fr.mjs').then((r2) => r2["default"] || r2.default || r2));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DyjMnFWx.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DF95BMT0.mjs'));
...
export { _export_sfc as _, useRoute$1 as a, useRuntimeConfig as b, useNuxtApp as c, asyncDataDefaults as d, entry$1 as default, createError as e, useRequestEvent as f, useRouter as g, nuxtLinkDefaults as h, br as i, navigateTo as n, qn as q, resolveRouteObject as r, useHead as u };
